class DiaryEntry
  ...
  def reading_time(wpm) # wpm is an integer representing the number
                        # of words the user can read per minute
    # Returns an integer representing an estimate of the reading time
    # in minutes for the contents at the given wpm
    count_words < wpm ? 1 : (count_words / wpm.to_f).ceil
  end
